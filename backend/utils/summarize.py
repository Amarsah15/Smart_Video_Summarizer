...
SUMMARIZER_MODEL = os.getenv("SUMMARIZER_MODEL", "facebook/bart-large-cnn").strip() or "facebook/bart-large-cnn"
_summarizer = None
...
def _extractive_summary_ranked(text, summary_length="medium"):
    ...
    sentence_limit_map = {"short": 3, "medium": 5, "long": 8}
    word_limit_map = {"short": 70, "medium": 130, "long": 220}
...
def _extractive_summary(text, summary_length="medium"):
    ...
    sentence_limit_map = {"short": 3, "medium": 5, "long": 7}
    word_limit_map = {"short": 70, "medium": 120, "long": 180}
